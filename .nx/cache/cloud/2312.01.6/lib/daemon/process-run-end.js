  ...
  ta = (r, e, t, s) => {
    if ((e && typeof e == 'object') || typeof e == 'function')
      for (let i of af(e))
        !uf.call(r, i) &&
          i !== t &&
          Zr(r, i, { get: () => e[i], enumerable: !(s = of(e, i)) || s.enumerable });
    return r;
  };
var lf = (r, e, t) => (
    (t = r != null ? nf(cf(r)) : {}),
    ta(e || !r || !r.__esModule ? Zr(t, 'default', { value: r, enumerable: !0 }) : t, r)
  ),
  ...
  try {
    try {
      ...
      let { appRootPath: e } = U('@nrwl/tao/src/utils/app-root'),
        { getDependencyConfigs: t } = U('@nrwl/workspace/src/tasks-runner/utils'),
        { tasksRunnerV2: s } = U('@nrwl/workspace/src/tasks-runner/tasks-runner-v2'),
        i;
      try {
...
var la = E((gr, Ci) => {
  ...
  (function (r, e) {
    typeof gr == 'object' && typeof Ci == 'object'
      ...
      : typeof gr == 'object'
      ? (gr['electron-machine-id'] = e(require('child_process'), require('crypto')))
    ...
    return (function (t) {
      function s(n) {
        ...
        return t[n].call(o.exports, o, o.exports, s), (o.loaded = !0), o.exports;
      }
      var i = {};
      ...
      function (t, s, i) {
        ...
        t.exports = function (C, L, v, A, I, B, q) {
          h(v, L, A);
          var ue,
            se,
            H,
            ...
            X = T[p] || T[_] || (I && T[I]),
            z = X || Ee(I),
            be = I ? (Ce ? Ee('entries') : z) : void 0,
            m = (L == 'Array' && T.entries) || X;
          if (
            (m &&
              ((H = d(m.call(new C()))),
              H !== Object.prototype && (f(H, k, !0), n || l(H, p) || a(H, p, S))),
            Ce &&
              X &&
              X.name !== O &&
              ((ie = !0),
            ...
            if (((ue = { values: Ce ? z : Ee(O), keys: B ? z : Ee(g), entries: be }), q))
      ...
      function (t, s) {
        var i = 0,
          n = Math.random();
        t.exports = function (o) {
          return 'Symbol('.concat(o === void 0 ? '' : o, ')_', (++i + n).toString(36));
        };
      },
      function (t, s, i) {
        'use strict';
...
`,
        ...
        function u(S) {
          return new f.default(function (C, L) {
            return (0, d.exec)(O[_], {}, function (v, A, I) {
      ...
      function (t, s, i) {
        ...
        t.exports = function (a) {
          return function (l, u, h) {
            ...
            } else for (; p > y; y++) if ((a || y in d) && d[y] === u) return a || y || 0;
            return !a && -1;
          };
        };
      },
          ...
          d = (t.exports = function (p, y, _, g, O) {
            ...
            if (c(A)) {
              for (S = l(p.length); S > B; B++)
                if (((v = y ? I(a((C = p[B]))[0], C[1]) : I(p[B])), v === h || v === f))
                  return v;
            } else
              for (L = A.call(p); !(C = L.next()).done; )
                if (((v = o(L, I, C.value, y)), v === h || v === f)) return v;
          });
      ...
      function (t, s) {
        t.exports = function (i, n, o) {
          ...
          switch (n.length) {
            ...
            case 4:
              return c ? i(n[0], n[1], n[2], n[3]) : i.call(o, n[0], n[1], n[2], n[3]);
          }
          return i.apply(o, n);
        };
      },
      ...
      function (t, s, i) {
        ...
        var n,
          ...
          Ee = (o = function (m) {
            ...
            (this.promise = new m(function (x, K) {
              if (R !== void 0 || w !== void 0) throw L('Bad Promise constructor');
              (R = x), (w = K);
            })),
              (this.resolve = p(R)),
              (this.reject = p(w));
                      ...
                      try {
                        yr
                          ? (K || (m._h == 2 && X(m), (m._h = 1)),
                            yr === !0
                              ? (Ne = x)
                              : (Yr && Yr.enter(), (Ne = yr(x)), Yr && Yr.exit()),
                            Ne === Ye.promise
        ...
        q ||
          ...
          (Ee = function () {
            var m = new n();
            (this.promise = m), (this.resolve = u(be, m, 1)), (this.reject = u(z, m, 1));
          })),
...
Pe(ma, {
  ...
  NX_CLOUD_DISTRIBUTED_EXECUTION_STOP_AGENTS_ON_FAILURE: () => If,
...
function Sr() {
  try {
    return (0, Si.execSync)('git rev-parse HEAD', { stdio: 'pipe' }).toString().trim();
  } catch {
    return;
  }
}
function Af() {
  try {
    return (0, Si.execSync)('git rev-parse --symbolic-full-name HEAD', { stdio: 'pipe' })
      .toString()
      .trim();
  } catch {
    return;
...
function Uf() {
  ...
  (Cr =
    ...
    (P = process.env.NX_VERBOSE_LOGGING === 'true' || r.NX_VERBOSE_LOGGING === 'true'),
    (Se =
      process.env.NX_CLOUD_NO_TIMEOUTS === 'true' || r.NX_CLOUD_NO_TIMEOUTS === 'true');
}
function Ti() {
  return pa();
}
  ...
  dt = le(() => {
    ...
    (gf = ua()),
      ...
      (xf = process.env.NX_CLOUD_DISTRIBUTED_EXECUTION_AGENT_COUNT
        ...
        : null),
      (If = process.env.NX_CLOUD_DISTRIBUTED_EXECUTION_STOP_AGENTS_ON_FAILURE != 'false'),
      ...
      (wr = process.env.NX_CLOUD_NUMBER_OF_RETRIES
        ...
        ? 10
        : 1),
      (bf = process.env.NX_NO_CLOUD === 'true');
    Uf();
  });
function kt(r) {
...
var Ui = E((Sy, Ia) => {
  'use strict';
  var rd = ss();
  Ia.exports = function (e, t, s) {
    var i = s.config.validateStatus;
    !s.status || !i || i(s.status)
      ? e(s)
      : t(
          rd('Request failed with status code ' + s.status, s.config, null, s.request, s),
        );
  };
});
var Na = E((Oy, ba) => {
  'use strict';
  var is = te();
  ba.exports = is.isStandardBrowserEnv()
    ? (function () {
        return {
...
var Ga = E((Ly, Ha) => {
  ...
  Ha.exports = function (e) {
    return new Promise(function (s, i) {
      ...
      function f() {
        if (a) {
          var p = 'getAllResponseHeaders' in a ? ld(a.getAllResponseHeaders()) : null,
            y = !c || c === 'text' || c === 'json' ? a.responseText : a.response,
            _ = {
              data: y,
              status: a.status,
      ...
      'setRequestHeader' in a &&
        ...
        ns.isUndefined(e.withCredentials) || (a.withCredentials = !!e.withCredentials),
...
var Pi = E((Dy, ja) => {
  ...
  function yd(r) {
      ...
      return (
        ...
        Object.defineProperty(y, 'enabled', {
          ...
          get: () =>
            f !== null
              ? f
              : (d !== t.namespaces && ((d = t.namespaces), (p = t.enabled(u))), p),
          set: (_) => {
            f = _;
          },
        }),
    ...
    function o(u) {
      ...
      let h, f;
      for (h = 0, f = t.skips.length; h < f; h++) if (t.skips[h].test(u)) return !1;
      for (h = 0, f = t.names.length; h < f; h++) if (t.names[h].test(u)) return !0;
      return !1;
    }
    function c(u) {
      return u
...
var Za = E((Fy, Ya) => {
  ...
  ye('no-color') || ye('no-colors') || ye('color=false') || ye('color=never')
    ? (Je = 0)
    : (ye('color') || ye('colors') || ye('color=true') || ye('color=always')) && (Je = 1);
  'FORCE_COLOR' in V &&
    (V.FORCE_COLOR === 'true'
      ? (Je = 1)
      : V.FORCE_COLOR === 'false'
      ? (Je = 0)
      : (Je = V.FORCE_COLOR.length === 0 ? 1 : Math.min(parseInt(V.FORCE_COLOR, 10), 3)));
  function ki(r) {
...
`,
  ...
  Ja.O = function (r) {
    return (this.inspectOpts.colors = this.useColors), cs.inspect(r, this.inspectOpts);
  };
});
var ec = E((By, Hi) => {
  'use strict';
...
var Wi = E((Py, Ki) => {
  ...
  var Et = require('url'),
    ...
    Ud = require('http'),
    Fd = require('https'),
    Vi = require('stream').Writable,
    nc = require('assert'),
    oc = rc(),
    ji = ['abort', 'aborted', 'connect', 'error', 'socket', 'timeout'],
  ...
  var Bd = Ir('ERR_INVALID_URL', 'Invalid URL', TypeError),
    sc = Ir('ERR_FR_REDIRECTION_FAILURE', 'Redirected request failed'),
    Md = Ir('ERR_FR_TOO_MANY_REDIRECTS', 'Maximum number of redirects exceeded'),
    Pd = Ir(
      'ERR_FR_MAX_BODY_LENGTH_EXCEEDED',
      'Request body larger than maxBodyLength limit',
    ),
    kd = Ir('ERR_STREAM_WRITE_AFTER_END', 'write after end'),
    qd = Vi.prototype.destroy || cc;
  function ne(r, e) {
    Vi.call(this),
  ...
  ne.prototype = Object.create(Vi.prototype);
  ...
  ne.prototype.end = function (r, e, t) {
    if ((xr(r) ? ((t = r), (r = e = null)) : xr(e) && ((t = e), (e = null)), !r))
  ...
  ne.prototype._processResponse = function (r) {
    ...
    i && (s = Object.assign({ Host: r.req.getHeader('host') }, this._options.headers));
    ...
    var o = zi(/^host$/i, this._options.headers),
      ...
      a = o || c.host,
      l = /^\w+:/.test(t) ? this._currentUrl : Et.format(Object.assign(c, { host: a })),
      u;
    try {
      u = Et.resolve(l, t);
    } catch (p) {
  ...
  function Xi(r, e) {
    for (var t of ji) r.removeListener(t, $i[t]);
...
var pc = E((qy, dc) => {
  ...
  function fc(r, e, t) {
    if (
      ((r.hostname = e.host), (r.host = e.host), (r.port = e.port), (r.path = t), e.auth)
    ) {
      var s = Buffer.from(e.auth.username + ':' + e.auth.password, 'utf8').toString(
        'base64',
      );
    ...
    return new Promise(function (s, i) {
      ...
      if (
        ...
        if (!Buffer.isBuffer(c))
          if (br.isArrayBuffer(c)) c = Buffer.from(new Uint8Array(c));
          else if (br.isString(c)) c = Buffer.from(c, 'utf-8');
          else
            return o(
              ls(
      ...
      var O = hc.test(p),
        ...
        C = {
          path: jd(d.path, e.params, e.paramsSerializer).replace(/^\?/, ''),
      ...
      if (!L && L !== !1) {
        ...
        if (A) {
          ...
          if (
            q &&
            ((L = { host: I.hostname, port: I.port, protocol: I.protocol }), I.auth)
          ) {
            var se = I.auth.split(':');
      ...
      L &&
        ...
        fc(C, L, p + '//' + d.hostname + (d.port ? ':' + d.port : '') + C.path));
      var H,
      ...
      e.transport
        ...
        : e.maxRedirects === 0
        ? (H = Ee ? Xd : $d)
        : (e.maxRedirects && (C.maxRedirects = e.maxRedirects), (H = Ee ? Wd : Kd)),
        ...
        if (!k.aborted) {
          ...
          if (T.statusCode !== 204 && z.method !== 'HEAD' && e.decompress !== !1)
            switch (T.headers['content-encoding']) {
              ...
              case 'compress':
              case 'deflate':
                (X = X.pipe(Yd.createUnzip())), delete T.headers['content-encoding'];
                break;
            }
          var be = {
            status: T.statusCode,
          ...
          if (e.responseType === 'stream') (be.data = X), uc(n, o, be);
          else {
            var m = [],
              R = 0;
      ...
      if (
        (k.on('error', function (T) {
          (k.aborted && T.code !== 'ERR_FR_TOO_MANY_REDIRECTS') || o(Zi(T, e, null, k));
        }),
        e.timeout)
      ) {
...
var fs = E((Hy, yc) => {
  ...
  function Ec(r, e) {
    !re.isUndefined(r) && re.isUndefined(r['Content-Type']) && (r['Content-Type'] = e);
  }
  function ep() {
    var r;
    return (
      ...
      function (e, t) {
        return (
          ...
          re.isBlob(e)
            ...
            ? (Ec(t, 'application/x-www-form-urlencoded;charset=utf-8'), e.toString())
      ...
      function (e) {
        ...
        if (n || (i && re.isString(e) && e.length))
          try {
            ...
            if (n) throw o.name === 'SyntaxError' ? Jd(o, this, 'E_JSON_PARSE') : o;
          }
        return e;
      },
    ],
...
var Cc = E((Vy, wc) => {
  ...
  wc.exports = function (e) {
    ...
    return t(e).then(
      function (i) {
        return en(e), (i.data = Qi.call(e, i.data, i.headers, e.transformResponse)), i;
      },
      function (i) {
        return (
          sp(i) ||
...
var bc = E(($y, Ic) => {
  ...
  Ic.exports = { isOlderVersion: xc, assertOptions: op, validators: rn };
});
var Fc = E((Xy, Uc) => {
  'use strict';
  var Ac = te(),
    ...
    Vt = Dc.validators;
  function Nr(r) {
    (this.defaults = r), (this.interceptors = { request: new Nc(), response: new Nc() });
  }
  Nr.prototype.request = function (e) {
    ...
    if (!i) {
      var c = [Lc, void 0];
      for (
        Array.prototype.unshift.apply(c, s), c.concat(n), o = Promise.resolve(e);
        c.length;
  ...
  Ac.forEach(['delete', 'get', 'head', 'options'], function (e) {
    Nr.prototype[e] = function (t, s) {
      return this.request(ds(s || {}, { method: e, url: t, data: (s || {}).data }));
    };
  });
  ...
  try {
    ...
    if (s == 429) {
      if (!Es) {
        ...
        Xc.note({ title: `Received Code ${s}. ${i} Retrying in ${n}ms.` }), (Es = kt(n));
      }
      await Es, (Es = null);
    } else {
      let n = 1e3 + (wr + 1 - e) * 4e3 * Math.random();
      P && Xc.note({ title: `Received Code ${s}. Retrying in ${n}ms.` }), await kt(n);
    }
    return qe(r, e - 1);
  }
}
...
function dp() {
  try {
    return (
      U('nx/src/tasks-runner/life-cycles/dynamic-run-many-terminal-output-life-cycle'), !0
    );
  } catch {
    try {
      return (
...
var Kt = E((u_, au) => {
  ...
  var Qc =
    ...
    Rp = (nu && Symbol.asyncIterator) || Symbol('asyncIterator not implemented'),
  ...
  au.exports = class ou extends eu {
    ...
    set encoding(e) {
      ...
      if (this[oe] && e !== this[oe] && ((this[ze] && this[ze].lastNeed) || this[j]))
    ...
    write(e, t, s) {
      ...
      return (
        ...
        this[Y]
          ? (this.flowing && this[j] !== 0 && this[vs](!0),
          ...
          ? (typeof e == 'string' &&
            ...
            s && i(s),
            this.flowing)
          : (this[j] !== 0 && this.emit('readable'), s && i(s), this.flowing)
      );
    }
    read(e) {
      if (this[Z]) return null;
      if (this[j] === 0 || e === 0 || e > this[j]) return this[Ge](), null;
      this[Y] && (e = null),
    ...
    [Xt]() {
      this[Z] ||
        ...
        (this[ws] = !0),
        this.emit('resume'),
        this.buffer.length ? this[vs]() : this[He] ? this[Ge]() : this.emit('drain'));
    }
    resume() {
      return this[Xt]();
    }
    ...
    [pn]() {
      return (
        this.buffer.length &&
          (this[Y] ? (this[j] -= 1) : (this[j] -= this.buffer[0].length)),
        this.buffer.shift()
      );
    }
    [vs](e) {
    ...
    pipe(e, t) {
      ...
      return (
        (t = t || {}),
        e === Qc.stdout || e === Qc.stderr ? (t.end = !1) : (t.end = t.end !== !1),
        (t.proxyErrors = !!t.proxyErrors),
        s
          ? t.end && e.end()
          : (this.pipes.push(t.proxyErrors ? new yn(this, e, t) : new Cs(this, e, t)),
            this[Ve] ? Ur(() => this[Xt]()) : this[Xt]()),
        e
      );
    }
    unpipe(e) {
    ...
    on(e, t) {
      ...
      return (
        e === 'data' && !this.pipes.length && !this.flowing
          ...
          : e === 'error' &&
            this[Ar] &&
            (this[Ve] ? Ur(() => t.call(this, this[Ar])) : t.call(this, this[Ar])),
        s
      );
    }
    get emittedEnd() {
    ...
    emit(e, t, ...s) {
      ...
      if (e === 'data') return t ? (this[Ve] ? Ur(() => this[mn](t)) : this[mn](t)) : !1;
      ...
      return {
        next: () => {
          ...
          let s = null,
            i = null,
            n = (l) => {
              this.removeListener('data', o), this.removeListener('end', c), i(l);
            },
            o = (l) => {
...
var Dn = E((fe) => {
  ...
  var wn = require('assert'),
    ...
    Os = class extends Op {
      ...
      reset() {
        if (!this[Wt]) return wn(this[F], 'zlib binding closed'), this[F].reset();
      }
      flush(e) {
        this.ended ||
    ...
    je = class extends Os {
      ...
      params(e, t) {
        if (!this[Wt]) {
          if (!this[F]) throw new Error('cannot switch params when binding is closed');
          if (!this[F].params) throw new Error('not supported in this implementation');
    ...
    On = class extends je {
      ...
      [vt](e) {
        return this[vn] ? ((this[vn] = !1), (e[9] = 255), super[vt](e)) : super[vt](e);
      }
    },
    Tn = class extends je {
      constructor(e) {
  ...
  var Vp = Qt(),
    ...
    Br = class {
      ...
      encode() {
        ...
        new Vp({
          path: ('PaxHeader/' + jp.basename(this.path)).slice(0, 99),
          mode: this.mode || 420,
          uid: this.uid || null,
          gid: this.gid || null,
          size: t,
...
`,
  ...
  var $p = (r, e) => (e ? Object.keys(r).reduce((t, s) => ((t[s] = r[s]), t), e) : r),
    Xp = (r) =>
      r
        .replace(/\n$/, '')
        .split(
...
var eo = E((b_, Gu) => {
  ...
  var Fu = Kt(),
    ...
    Ae = Zt(),
    Jp = er(),
    Pu = (r, e) => (e ? ((r = Ae(r).replace(/^\.(\/|$)/, '')), Jp(e) + '/' + r) : Ae(r)),
    Qp = 16 * 1024 * 1024,
    Nu = Symbol('process'),
    Lu = Symbol('file'),
    Au = Symbol('directory'),
    ...
    Fs = ku(
      class extends Fu {
        constructor(e, t) {
          ...
          (this.win32 = !!t.win32 || process.platform === 'win32'),
            this.win32 &&
              ...
              (e = e.replace(/\\/g, '/'))),
            (this.absolute = Ae(t.absolute || bu.resolve(this.cwd, e))),
            this.path === '' && (this.path = './'),
            s &&
        ...
        [Du](e) {
          (this.type = 'Link'),
            (this.linkpath = Ae(bu.relative(this.cwd, e))),
            (this.stat.size = 0),
            this[Mr](),
            this.end();
        }
        ...
        [Kn](e) {
          ...
          this.write(t) ? this[jn]() : this[Jn](() => this[jn]());
        }
        [Jn](e) {
          this.once('drain', e);
        }
...
var to = E((L_, ju) => {
  ...
  b.prototype.reduceReverse = function (r, e) {
    ...
    for (var i = this.length - 1; s !== null; i--) (t = r(t, s.value, i)), (s = s.prev);
    return t;
  };
  ...
  function sm(r, e, t) {
    ...
    return (
      s.next === null && (r.tail = s), s.prev === null && (r.head = s), r.length++, s
    );
  }
  function im(r, e) {
    (r.tail = new St(e, r.tail, null, r)), r.head || (r.head = r.tail), r.length++;
  }
  function nm(r, e) {
    (r.head = new St(e, null, r.head, r)), r.tail || (r.tail = r.head), r.length++;
  }
  function St(r, e, t, s) {
    ...
    ho = fm(
      class extends om {
        ...
        [oo](e) {
          ...
          zs[t](e.absolute, (s, i) => {
            (e.pending = !1), (this[Be] -= 1), s ? this.emit('error', s) : this[Ps](e, i);
          });
        }
        [Ps](e, t) {
        ...
        [ao](e) {
          (e.pending = !0),
            ...
            zs.readdir(e.absolute, (t, s) => {
              if (((e.pending = !1), (this[Be] -= 1), t)) return this.emit('error', t);
              this[qs](e, s);
            });
        }
        [qs](e, t) {
        ...
        [Ot]() {
          if (!this[Ms]) {
            this[Ms] = !0;
            for (let e = this[Fe].head; e !== null && this[Be] < this.jobs; e = e.next)
  ...
  var ar = Symbol('_autoClose'),
    ...
    Ys = class extends dm {
      ...
      [ir]() {
        if (!this[it]) {
          this[it] = !0;
          let e = this[yo]();
          if (e.length === 0) return process.nextTick(() => this[po](null, 0, e));
          ae.read(this[D], e, 0, e.length, null, (t, s, i) => this[po](t, s, i));
        }
      }
      [po](e, t, s) {
      ...
      [xe]() {
        if (this[ar] && typeof this[D] == 'number') {
          let e = this[D];
          (this[D] = null),
            ae.close(e, (t) => (t ? this.emit('error', t) : this.emit('close')));
        }
      }
      [nr](e) {
      ...
      [ir]() {
        ...
        try {
          if (!this[it]) {
            ...
            do {
              let t = this[yo](),
                s = t.length === 0 ? 0 : ae.readSync(this[D], t, 0, t.length, null);
    ...
    Ro = class extends Zs {
      ...
      [Xs](e) {
        let t = !0;
        try {
          this[sr](null, ae.writeSync(this[D], e, 0, e.length, this[Tt])), (t = !1);
        } finally {
          if (t)
            try {
              this[xe]();
...
var ii = E((B_, cl) => {
  ...
  cl.exports = mm(
    class extends ym {
              ...
              : ((this[Re] = null),
                ...
                n.ignore
                  ? (this[bt]('ignoredEntry', n),
                    ...
                    n.resume())
                  : (n.remain ? (this[_e] = 'body') : ((this[_e] = 'header'), n.end()),
                    this[Xe] ? this[Ke].push(n) : (this[Ke].push(n), this[vo]())));
          }
        }
      }
      [sl](e) {
      ...
      [bt](e, t, s) {
        !this[Ke].length && !this[Xe] ? this.emit(e, t, s) : this[Ke].push([e, t, s]);
      }
      [il](e) {
        switch ((this[bt]('meta', this[at]), e.type)) {
          case 'ExtendedHeader':
          case 'OldExtendedHeader':
      ...
      write(e) {
        ...
        (this[Hr] = !0), this[ce] ? this[ce].write(e) : this[Js](e), (this[Hr] = !1);
        let t = this[Ke].length ? !1 : this[Xe] ? this[Xe].flowing : !0;
        return (
          !t && !this[Ke].length && this[Xe].once('drain', (s) => this.emit('drain')), t
        );
      }
      [Co](e) {
      ...
      [So]() {
        if (this[It] && !this[nl] && !this[ct] && !this[ei]) {
          this[nl] = !0;
          let e = this[xt];
          if (e && e.blockRemain) {
      ...
      [Qs](e) {
        ...
        this[ct] || (this[ce] ? this[ce].end(e) : ((this[It] = !0), this.write(e)));
      }
    },
  );
});
var ni = E((M_, fl) => {
  ...
  fl.exports = (r, e, t) => {
    ...
    return (
      e.length && Tm(s, e),
      s.noResume || Om(s),
      s.file && s.sync ? xm(s) : s.file ? Im(s, t) : hl(s)
    );
  };
  var Om = (r) => {
      let e = r.onentry;
        ...
        i = (o, c, a) => {
          ...
          let h = 0,
            ...
            d = (p, y) => {
              ...
              if (u + g + 512 > c || ((u += g + 512), u >= c)) return l(null, u);
  ...
  var { promisify: Il } = require('util'),
    ...
    Gm = (r) => {
      ...
      return (
        ...
        (r.mkdirAsync = Il(r.mkdir)),
        (r.stat = r.stat || r.fs.stat || ut.stat),
        (r.statAsync = Il(r.stat)),
...
var Al = E((G_, Ll) => {
  ...
  var zm = process.env.__TESTING_MKDIRP_PLATFORM__ || process.platform,
    { resolve: Vm, parse: jm } = require('path'),
    $m = (r) => {
      if (/\0/.test(r))
...
var No = E((V_, kl) => {
  ...
  var { dirname: Pl } = require('path'),
    Io = (r, e, t) => {
      ...
      return s === r
        ...
        : e.mkdirAsync(r, e).then(
            () => t || r,
            (i) => {
              if (i.code === 'ENOENT') return Io(s, e).then((n) => Io(r, e, n));
    ...
    bo = (r, e, t) => {
      ...
      try {
        ...
        if (i.code === 'ENOENT') return bo(r, e, bo(s, e, t));
        if (i.code !== 'EEXIST' && i.code !== 'EROFS') throw i;
        try {
  ...
  kl.exports = { mkdirpManual: Io, mkdirpManualSync: bo };
});
var Gl = E((j_, Hl) => {
  'use strict';
...
var $l = E(($_, jl) => {
  ...
  var zl = require('fs'),
    ...
    Vl = +Lo[0] > 10 || (+Lo[0] == 10 && +Lo[1] >= 12),
    eE = Vl ? (r) => r.mkdir === zl.mkdir : () => !1,
    tE = Vl ? (r) => r.mkdirSync === zl.mkdirSync : () => !1;
  jl.exports = { useNative: eE, useNativeSync: tE };
});
var Jl = E((X_, Zl) => {
  'use strict';
  var hr = Nl(),
...
var nh = E((K_, ih) => {
  ...
  var ai = (r, e, t, s) => {
    ...
    hE = (r, e, t, s) => {
      ...
      e.isDirectory() && sh(Lt.resolve(r, e.name), t, s), Ao(Lt.resolve(r, e.name), t, s);
    },
    sh = (r, e, t) => {
      let s;
      try {
...
var uh = E((W_, Uo) => {
  ...
  var oh = Jl(),
    ...
    hi = (r, e) => r.get(Ie(e)),
    Gr = (r, e, t) => r.set(Ie(e), t),
    fE = (r, e) => {
      ve.stat(r, (t, s) => {
        (t || !s.isDirectory()) && (t = new li(r, (t && t.code) || 'ENOTDIR')), e(t);
      });
    };
  Uo.exports = (r, e, t) => {
    r = Ie(r);
    ...
    let y = Ie(ci.relative(f, r)).split('/');
  ...
  var fi = (r, e, t, s, i, n, o, c) => {
    ...
    ch = (r, e, t, s, i, n, o, c) => (a) => {
      a
        ? ve.lstat(r, (l, u) => {
            if (l) (l.path = l.path && Ie(l.path)), c(l);
              ...
              if (u.isSymbolicLink()) return c(new ui(r, r + '/' + e.join('/')));
              c(a);
            }
          })
  ...
  Uo.exports.sync = (r, e) => {
    ...
    let p = Ie(ci.relative(h, r)).split('/'),
      y = null;
    for (let _ = p.shift(), g = h; _ && (g += '/' + _); _ = p.shift())
      if (((g = Ie(ci.resolve(g))), !hi(u, g)))
        try {
          ...
          if (S.isDirectory()) {
            ...
            continue;
          } else if (S.isSymbolicLink()) return new ui(g, g + '/' + p.join('/'));
        }
    return f(y);
  };
});
    ...
    let r = new Map(),
      ...
      t = (l) =>
        l
          ...
          .slice(0, -1)
          .reduce(
            (h, f) => (h.length && (f = fh(h[h.length - 1], f)), h.push(f || '/'), h),
            [],
          ),
      s = new Set(),
      i = (l) => {
      ...
      n = (l) => {
        ...
        return (
          u.every((f) => f[0] === l) && h.every((f) => f[0] instanceof Set && f[0].has(l))
        );
      },
...
var yh = E((J_, Eh) => {
  ...
  var RE = process.env.__FAKE_PLATFORM__ || process.platform,
    ...
    { O_CREAT: wE, O_TRUNC: CE, O_WRONLY: SE, UV_FS_O_FILEMAP: mh = 0 } = vE.constants,
    OE = gE && !!mh,
    TE = 512 * 1024,
    xE = mh | CE | wE | SE;
...
var jo = E((Q_, Lh) => {
  ...
  var IE = require('assert'),
    ...
    BE = (r, e) => {
      ...
      let t = r + '.DELETE.' + bh.randomBytes(16).toString('hex');
      N.rename(r, t, (s) => {
        if (s) return e(s);
        N.unlink(t, e);
      });
    ...
    ME = (r) => {
      ...
      let e = r + '.DELETE.' + bh.randomBytes(16).toString('hex');
    ...
    Kr = class extends bE {
      ...
      [Sh](e) {
        ...
        if (!this.preservePaths) {
          ...
          if (s.includes('..') || (Xr && /^[a-z]:\.\.$/i.test(s[0])))
            return (
              this.warn('TAR_ENTRY_ERROR', "path contains '..'", { entry: e, path: t }),
              !1
            );
          let [i, n] = AE(t);
          i &&
      ...
      [Rh](e) {
        ...
        switch ((IE.equal(typeof e.absolute, 'string'), e.type)) {
          case 'Directory':
          case 'GNUDumpDir':
      ...
      [J](e, t) {
        e.name === 'CwdError'
          ? this.emit('error', e)
          : (this.warn('TAR_ENTRY_ERROR', e, { entry: t }), this[pr](), t.resume());
      }
      [lt](e, t, s) {
        Ih(
          me(e),
      ...
      [Ho](e, t) {
        ...
        i.on('error', (a) => {
          i.fd && N.close(i.fd, () => {}), (i.write = () => !0), this[J](a, e), t();
        });
        let n = 1,
          o = (a) => {
            if (a) {
        ...
        i.on('finish', (a) => {
          ...
          if (e.mtime && !this.noMtime) {
            ...
            let h = e.atime || new Date(),
              f = e.mtime;
            N.futimes(u, h, f, (d) => (d ? N.utimes(l, h, f, (p) => o(p && d)) : o()));
          }
          if (this[zr](e)) {
            n++;
            let h = this[Vr](e),
              f = this[jr](e);
            N.fchown(u, h, f, (d) => (d ? N.chown(l, h, f, (p) => o(p && d)) : o()));
          }
          o();
        });
      ...
      [Go](e, t) {
        ...
        this[lt](e.absolute, s, (i) => {
          ...
          e.mtime &&
            ...
            this[zr](e) && (n++, N.chown(e.absolute, this[Vr](e), this[jr](e), o)),
            o();
        });
      }
      [Ch](e) {
      ...
      [qo](e, t) {
        return e.type === 'File' && !this.unlink && t.isFile() && t.nlink <= 1 && !Xr;
      }
      [ko](e) {
        this[Oh]();
        let t = [e.path];
    ...
    Vo = class extends Kr {
      ...
      [ko](e) {
        ...
        if (s && (this.keep || (this.newer && s.mtime > e.mtime))) return this[zo](e);
      ...
      [Go](e, t) {
        ...
        if (this[zr](e))
          try {
            N.chownSync(e.absolute, this[Vr](e), this[jr](e));
          } catch {}
        t(), e.resume();
      }
      [lt](e, t) {
...
var Bh = E((eR, Fh) => {
  ...
  Fh.exports = (r, e, t) => {
    ...
    return (
      e.length && HE(s, e),
      s.file && s.sync ? GE(s) : s.file ? zE(s, t) : s.sync ? VE(s) : jE(s)
    );
  };
  var HE = (r, e) => {
        ...
        async downloadFile(e, t, s) {
          ...
          try {
            ...
            (n = await qe(() =>
              ...
              i.recordMetric({ ...Te(n), payloadSize: n.data.headers['content-length'] });
          } catch (c) {
            throw (
              (i.recordMetric(
          ...
          if (this.encryption.hasEncryption()) {
            await new Promise((a) => {
              n.data.pipe((0, Q.createWriteStream)(t)).on('close', () => a(null));
            }),
              this.encryption.decryptFile(t);
            let c = (0, Q.createReadStream)(t).pipe(_i.x({ cwd: Dt.dirname(t) }));
...
function Wo() {
  for (let r of Object.values($E))
    if (r.detectorFn(process.env)) {
      ...
      return (
        P && console.log(JSON.stringify(e, null, 2)), { ...e, inferredFromTaskRunner: !0 }
      );
    }
...
function YE(r) {
  return (
    ...
    {
      branch: ((t) =>
        t.TRAVIS_EVENT_TYPE === 'pull_request' ? t.TRAVIS_PULL_REQUEST : t.TRAVIS_BRANCH)(
        r,
      ),
      ref: null,
...
function ry(r) {
  return (
    ...
    {
      branch:
        r.SYSTEM_PULLREQUEST_PULLREQUESTNUMBER ?? r.BUILD_SOURCEBRANCHNAME ?? 'unknown',
      ref: null,
      ...
      authorAvatarUrl: null,
      repositoryUrl:
        r.SYSTEM_PULLREQUEST_SOURCEREPOSITORYURI ?? r.BUILD_REPOSITORY_URI ?? null,
    }
  );
}
function sy(r) {
...
function Yo() {
  try {
    return (0, Ko.execSync)('git log -1 --pretty=%B', { encoding: 'utf-8' }).trim();
  } catch {
    return null;
  }
}
function zh() {
  try {
    return (0, Ko.execSync)('git log -1 --pretty=%aN', { encoding: 'utf-8' }).trim();
  } catch {
    return null;
  }
}
...
var jh,
  ...
  Wh = le(() => {
    'use strict';
    (jh = require('fs')), ($h = require('util')), (Xh = require('zlib'));
    Lr();
    dt();
    Vh();
    _s();
...
` + JSON.stringify(n, null, 2),
            ...
            return (
              s.recordMetric(
                (i = n == null ? void 0 : n.axiosException) != null && i.response
                  ? Te(n.axiosException.response)
                  : Rt,
              ),
              (this.messages.apiError = this.messages.extractErrorMessage(n, 'api')),
              {}
            );
          }
        }
...
` + JSON.stringify(h, null, 2),
            ...
            return (
              (this.messages.apiError = this.messages.extractErrorMessage(h, 'api')), !1
            );
          }
        }
        nxCloudVersion() {
          try {
            let e = JSON.parse((0, jh.readFileSync)('package.json').toString());
