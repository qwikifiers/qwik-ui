  ...
  yo = (e, t, r, o) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let n of Co(t))
        !Eo.call(e, n) &&
          n !== r &&
          ot(e, n, { get: () => t[n], enumerable: !(o = vo(t, n)) || o.enumerable });
    return e;
  };
        ...
        .forEach(function (n, s) {
          ...
          if (i != null) {
            let u = i[1],
              ...
              c = a[0] === '"' && a[l] === '"';
            (a[0] === "'" && a[l] === "'") || c
              ? ((a = a.substring(1, l)), c && (a = a.replace(xo, Io)))
              : (a = a.trim()),
              (o[u] = a);
...
var ur = I((ge, it) => {
  ...
  (function (e, t) {
    typeof ge == 'object' && typeof it == 'object'
      ...
      : typeof ge == 'object'
      ? (ge['electron-machine-id'] = t(require('child_process'), require('crypto')))
    ...
    return (function (r) {
      ...
      function (r, o, n) {
        ...
        r.exports = function (R, b, v, U, w, N, L) {
          f(v, b, U);
          var K,
            j,
            B,
            z = function (_) {
              if (!C && _ in g) return g[_];
              switch (_) {
                case S:
                  return function () {
                    return new v(this, _);
            ...
            D = g[h] || g[y] || (w && g[w]),
            F = D || z(w),
            Z = w ? (J ? z('entries') : F) : void 0,
            m = (b == 'Array' && g.entries) || D;
          if (
            (m &&
              ((B = d(m.call(new R()))),
              B !== Object.prototype && (p(B, A, !0), s || l(B, h) || a(B, h, T))),
            J &&
              D &&
              D.name !== x &&
              ((V = !0),
            ...
            if (((K = { values: J ? F : z(x), keys: N ? F : z(S), entries: Z }), L))
      ...
      function (r, o, n) {
        ...
        (h && C) ||
          ((h = function (v) {
            for (var U = [], w = 1; arguments.length > w; ) U.push(arguments[w++]);
            return (
              (x[++S] = function () {
                l(typeof v == 'function' ? v : Function(v), U);
              }),
              s(S),
              S
            );
          ...
          n(11)(d) == 'process'
            ...
            : (s =
                T in f('script')
                  ? function (v) {
                      c.appendChild(f('script'))[T] = function () {
                        c.removeChild(this), R.call(v);
                      };
                    }
                  : function (v) {
                      setTimeout(a(R, v, 1), 0);
                    })),
      ...
      function (r, o, n) {
        ...
        function u(T) {
          return (0, h.createHash)('sha256').update(T).digest('hex');
        }
        function a(T) {
          switch (y) {
            case 'darwin':
...
`,
        ...
        function l(T) {
          var R = a((0, d.execSync)(x[y]).toString());
          return T ? R : u(R);
        }
        function c(T) {
          return new p.default(function (R, b) {
            return (0, d.exec)(x[y], {}, function (v, U, w) {
              if (v) return b(new Error('Error while obtaining machine id: ' + v.stack));
              var N = a(U.toString());
              return R(T ? N : u(N));
            });
          });
      ...
      function (r, o, n) {
        ...
        r.exports = function (a) {
          return function (l, c, f) {
            ...
            } else for (; h > C; C++) if ((a || C in d) && d[C] === c) return a || C || 0;
            return !a && -1;
          };
        };
      },
      function (r, d, n) {
        var s = n(7),
          ...
          f = {},
          p = {},
          d = (r.exports = function (h, C, y, S, x) {
            var T,
              R,
              b,
              v,
              ...
              w = s(y, S, C ? 2 : 1),
              N = 0;
            if (typeof U != 'function') throw TypeError(h + ' is not iterable!');
            if (u(U)) {
              for (T = l(h.length); T > N; N++)
                if (((v = C ? w(a((R = h[N]))[0], R[1]) : w(h[N])), v === f || v === p))
                  return v;
            } else
              for (b = U.call(h); !(R = b.next()).done; )
                if (((v = i(b, w, R.value, C)), v === f || v === p)) return v;
          });
      ...
      function (r, o, n) {
        ...
        r.exports =
          ...
          function (p, d) {
            ...
            return (
              p !== null
                ? ((l[c] = s(p)), (h = new l()), (l[c] = null), (h[a] = p))
                : (h = f()),
              d === void 0 ? h : i(h, d)
            );
          };
      ...
      function (r, o, n) {
        ...
        r.exports = n(4)
          ...
          : function (a, l) {
              i(a);
              for (var c, f = u(l), p = f.length, d = 0; p > d; )
                s.f(a, (c = f[d++]), l[c]);
              return a;
            };
      },
      ...
      function (r, o, n) {
        ...
        var s,
          ...
          L = !!(function () {
            try {
              var m = v.resolve(1),
                _ = ((m.constructor = {})[n(1)('species')] = function (E) {
                  E(N, N);
                });
              return (
                (w || typeof PromiseRejectionEvent == 'function') &&
                m.then(N) instanceof _
              );
            } catch {}
          })(),
          K = function (m, _) {
          ...
          B = function (m) {
            return K(v, m) ? new z(m) : new i(m);
          },
          z = (i = function (m) {
            var _, E;
            (this.promise = new m(function (O, q) {
              if (_ !== void 0 || E !== void 0) throw b('Bad Promise constructor');
              (_ = O), (E = q);
            })),
              (this.resolve = h(_)),
              (this.reject = h(E));
                      ...
                      try {
                        ye
                          ? (q || (m._h == 2 && D(m), (m._h = 1)),
                            ye === !0
                              ? (ee = O)
                              : (Le && Le.enter(), (ee = ye(O)), Le && Le.exit()),
                            ee === ne.promise
          ...
          g = function (m) {
            if (m._h == 1) return !1;
            for (var _, E = m._a || m._c, O = 0; E.length > O; )
              if (((_ = E[O++]), _.fail || !g(_.promise))) return !1;
            return !0;
          },
          D = function (m) {
            x.call(l, function () {
        ...
        L ||
          ...
          (s.prototype = n(56)(v.prototype, {
            then: function (m, _) {
              var E = B(S(this, v));
              return (
                (E.ok = typeof m != 'function' || m),
                (E.fail = typeof _ == 'function' && _),
                (E.domain = w ? U.domain : void 0),
                this._c.push(E),
          ...
          (z = function () {
            var m = new s();
            (this.promise = m), (this.resolve = c(Z, m, 1)), (this.reject = c(F, m, 1));
          })),
          p(p.G + p.W + p.F * !L, { Promise: v }),
          n(18)(v, R),
          n(59)(R),
          (u = n(6)[R]),
          p(p.S + p.F * !L, R, {
            reject: function (m) {
              var _ = B(this),
                E = _.reject;
              return E(m), _.promise;
            },
          }),
          p(p.S + p.F * (a || !L), R, {
            resolve: function (m) {
              if (m instanceof v && K(m.constructor, this)) return m;
              var _ = B(this),
                E = _.resolve;
              return E(m), _.promise;
            },
                ...
                var _ = this,
                  ...
                  se = A(function () {
                    ...
                    y(m, !1, function (Ae) {
                      ...
                      fe.push(void 0),
                        ee++,
                        _.resolve(Ae).then(function (pe) {
                          Re || ((Re = !0), (fe[ye] = pe), --ee || O(fe));
                        }, q);
                    }),
                      --ee || O(fe);
                  });
...
var cr = {};
Be(cr, {
  configureLightClientRequire: () => Uo,
  configuredPaths: () => at,
...
Be(_r, {
  ACCESS_TOKEN: () => Te,
  DEFAULT_FILE_SIZE_LIMIT: () => Mo,
  DISTRIBUTED_TASK_EXECUTION_INTERNAL_ERROR_STATUS_CODE: () => Do,
  ENCRYPTION_KEY: () => dr,
  NO_COMPLETED_TASKS_TIMEOUT: () => Bo,
  NO_MESSAGES_TIMEOUT: () => Lo,
  NUMBER_OF_AXIOS_RETRIES: () => Ie,
  ...
  NX_CLOUD_NO_TIMEOUTS: () => De,
  NX_CLOUD_UNLIMITED_OUTPUT: () => Po,
  NX_NO_CLOUD: () => Ho,
  UNLIMITED_FILE_SIZE: () => Fo,
  UNLIMITED_TIMEOUT: () => lt,
  VERBOSE_LOGGING: () => X,
...
function xe() {
  try {
    return (0, ct.execSync)('git rev-parse HEAD', { stdio: 'pipe' }).toString().trim();
  } catch {
    return;
  }
}
function Vo() {
  try {
    return (0, ct.execSync)('git rev-parse --symbolic-full-name HEAD', { stdio: 'pipe' })
      .toString()
      .trim();
  } catch {
    return;
...
function Xo() {
  try {
    let e = (0, fr.readFileSync)((0, Me.join)(Ao, 'nx-cloud.env'));
    return So.parse(e);
  } catch {
    return {};
  }
...
function $o() {
  ...
  (Te =
    ...
    (X = process.env.NX_VERBOSE_LOGGING === 'true' || e.NX_VERBOSE_LOGGING === 'true'),
    (De =
      process.env.NX_CLOUD_NO_TIMEOUTS === 'true' || e.NX_CLOUD_NO_TIMEOUTS === 'true');
}
function ft() {
  return hr();
}
...
function zo() {
  let e = (0, Me.parse)(process.argv[1]).name,
  ...
  he = te(() => {
    ...
    (So = ar()),
      ...
      (Bo = process.env.NX_CLOUD_ORCHESTRATOR_TIMEOUT_MS
        ...
        : 36e5),
      (Fo = 1e3 * 1e3 * 1e4),
      (Po = process.env.NX_CLOUD_UNLIMITED_OUTPUT === 'true'),
      (Mo = 1e3 * 1e3 * 300),
      (Do = 166),
      (qo = process.env.NX_CLOUD_DISTRIBUTED_EXECUTION_AGENT_COUNT
        ? Number(process.env.NX_CLOUD_DISTRIBUTED_EXECUTION_AGENT_COUNT)
        : null),
      (ko = process.env.NX_CLOUD_DISTRIBUTED_EXECUTION_STOP_AGENTS_ON_FAILURE != 'false'),
      (pr = process.env.NX_CLOUD_FORCE_METRICS === 'true'),
      (Ie = process.env.NX_CLOUD_NUMBER_OF_RETRIES
...
var gr = I((ta, Rr) => {
  ...
  var pt = Symbol('singleComment'),
    ...
    Yo = () => '',
    Jo = (e, t, r) => e.slice(t, r).replace(/\S/g, ' '),
    Qo = (e, t) => {
      let r = t - 1,
        o = 0;
      for (; e[r] === '\\'; ) (r -= 1), (o += 1);
  ...
  Rr.exports = (e, t = {}) => {
    ...
    for (let u = 0; u < e.length; u++) {
      let a = e[u],
        l = e[u + 1];
      if ((!n && a === '"' && (Qo(e, u) || (o = !o)), !o)) {
        if (!n && a + l === '//') (i += e.slice(s, u)), (s = u), (n = pt), u++;
        else if (
          n === pt &&
          a + l ===
            `\r
...
var Tr = {};
Be(Tr, { getCloudOptions: () => ts });
function ts() {
  var o, n;
  let e = JSON.parse(Zo((0, Ir.readFileSync)(`${es}/nx.json`).toString())),
    t = {},
    r = [];
...
var Ir,
  ...
  xr = te(() => {
    'use strict';
    (Ir = require('fs')), (Zo = gr()), ({ workspaceRoot: es } = de());
  });
function dt(e) {
...
var ke = I((sa, Ar) => {
  ...
  Ar.exports = function (t, r, o) {
    ...
    if (o) n = o(r);
      ...
      var s = [];
      me.forEach(r, function (a, l) {
        a === null ||
          typeof a > 'u' ||
          (me.isArray(a) ? (l = l + '[]') : (a = [a]),
          me.forEach(a, function (f) {
            me.isDate(f)
              ? (f = f.toISOString())
              : me.isObject(f) && (f = JSON.stringify(f)),
              s.push(Nr(l) + '=' + Nr(f));
          }));
      }),
        (n = s.join('&'));
...
var Et = I((la, qr) => {
  ...
  qr.exports = function (t, r, o) {
    ...
    !o.status || !n || n(o.status)
      ? t(o)
      : r(
          Rs('Request failed with status code ' + o.status, o.config, null, o.request, o),
        );
  };
});
var Hr = I((fa, kr) => {
...
var Jr = I((_a, Yr) => {
  'use strict';
  var zr = H();
  Yr.exports = zr.isStandardBrowserEnv()
    ? (function () {
...
var Zr = I((va, Qr) => {
  ...
  Qr.exports = function (t) {
    return new Promise(function (o, n) {
      ...
      var f = bs(t.baseURL, t.url);
      a.open(t.method.toUpperCase(), ws(f, t.params, t.paramsSerializer), !0),
        (a.timeout = t.timeout);
      function p() {
        if (a) {
          var h = 'getAllResponseHeaders' in a ? Us(a.getAllResponseHeaders()) : null,
            C = !u || u === 'text' || u === 'json' ? a.responseText : a.response,
            y = {
              data: C,
              status: a.status,
      ...
      if (
        ...
        var d =
          (t.withCredentials || Ss(f)) && t.xsrfCookieName
      ...
      'setRequestHeader' in a &&
        ...
        Xe.isUndefined(t.withCredentials) || (a.withCredentials = !!t.withCredentials),
  ...
  function Ps(e) {
    ...
    function r(c) {
      ...
      function C(...y) {
        ...
        let R = 0;
        (y[0] = y[0].replace(/%([a-zA-Z%])/g, (v, U) => {
          if (v === '%%') return '%';
          R++;
          let w = r.formatters[U];
          if (typeof w == 'function') {
            let N = y[R];
            (v = w.call(S, N)), y.splice(R, 1), R--;
          }
          return v;
        })),
          r.formatArgs.call(S, y),
          (S.log || r.log).apply(S, y);
      }
      return (
        (C.namespace = c),
        ...
        Object.defineProperty(C, 'enabled', {
          ...
          get: () =>
            p !== null
              ? p
              : (d !== r.namespaces && ((d = r.namespaces), (h = r.enabled(c))), h),
          set: (y) => {
            p = y;
          },
        }),
...
var cn = I((Ra, un) => {
  ...
  'FORCE_COLOR' in P &&
    (P.FORCE_COLOR === 'true'
      ...
      : P.FORCE_COLOR === 'false'
      ? (oe = 0)
      : (oe = P.FORCE_COLOR.length === 0 ? 1 : Math.min(parseInt(P.FORCE_COLOR, 10), 3)));
  function Tt(e) {
  ...
  function xt(e, t) {
    ...
    if ('CI' in P)
      return [
        ...
        'GITHUB_ACTIONS',
        'BUILDKITE',
      ].some((o) => o in P) || P.CI_NAME === 'codeship'
        ? 1
        : r;
    ...
    if ('TERM_PROGRAM' in P) {
      let o = parseInt((P.TERM_PROGRAM_VERSION || '').split('.')[0], 10);
  ...
  function Vs(e) {
    let t = xt(e, e && e.isTTY);
    return Tt(t);
  }
  un.exports = {
    supportsColor: Vs,
    stdout: Tt(xt(!0, an.isatty(1))),
    stderr: Tt(xt(!0, an.isatty(2))),
  };
});
var fn = I((M, ze) => {
  'use strict';
  ...
  function $s() {
    return 'colors' in M.inspectOpts
      ? !!M.inspectOpts.colors
...
` + s,
  ...
  function Ws() {
    return M.inspectOpts.hideDate ? '' : new Date().toISOString() + ' ';
  }
  function zs(...e) {
...
`,
  ...
  function Qs(e) {
    e.inspectOpts = {};
    let t = Object.keys(M.inspectOpts);
    for (let r = 0; r < t.length; r++) e.inspectOpts[t[r]] = M.inspectOpts[t[r]];
  }
  ze.exports = It()(M);
  var { formatters: ln } = ze.exports;
  ln.o = function (e) {
    return (
...
`,
  ...
  ln.O = function (e) {
    return (this.inspectOpts.colors = this.useColors), We.inspect(e, this.inspectOpts);
  };
});
var pn = I((ga, Ot) => {
  'use strict';
...
var Bt = I((Ta, Lt) => {
  ...
  var ce = require('url'),
    ...
    vn = require('assert'),
    Cn = hn(),
    St = ['abort', 'aborted', 'connect', 'error', 'socket', 'timeout'],
  ...
  var ti = be('ERR_INVALID_URL', 'Invalid URL', TypeError),
    ...
    ri = be('ERR_FR_TOO_MANY_REDIRECTS', 'Maximum number of redirects exceeded'),
    ni = be(
      'ERR_FR_MAX_BODY_LENGTH_EXCEEDED',
      'Request body larger than maxBodyLength limit',
    ),
    oi = be('ERR_STREAM_WRITE_AFTER_END', 'write after end'),
    si = Ut.prototype.destroy || yn;
  function $(e, t) {
    Ut.call(this),
  ...
  $.prototype.end = function (e, t, r) {
    if ((we(e) ? ((r = e), (e = t = null)) : we(t) && ((r = t), (t = null)), !e))
      ...
      Object.keys(e).forEach(function (o) {
        ...
        function u(l, c, f) {
          if (le(l)) {
            ...
            if (!le(p.protocol)) throw new ti({ input: l });
            l = p;
          } else wt && l instanceof wt ? (l = _n(l)) : ((f = c), (c = l), (l = { protocol: n }));
          return (
            we(c) && ((f = c), (c = null)),
            (c = Object.assign(
            ...
            vn.equal(c.protocol, n, 'protocol mismatch'),
            Cn('options', c),
            new $(c, f)
          );
        }
  ...
  function At(e, t) {
    for (var r of St) e.removeListener(r, Nt[r]);
...
var On = I((Oa, xn) => {
  ...
  function Tn(e, t, r) {
    if (
      ((e.hostname = t.host), (e.host = t.host), (e.port = t.port), (e.path = r), t.auth)
    ) {
      var o = Buffer.from(t.auth.username + ':' + t.auth.password, 'utf8').toString(
        'base64',
      );
      e.headers['Proxy-Authorization'] = 'Basic ' + o;
    }
    e.beforeRedirect = function (s) {
      (s.headers.host = s.host), Tn(s, t, s.href);
    };
  }
    ...
    return new Promise(function (o, n) {
      ...
      if (
        ('User-Agent' in a || 'user-agent' in a
          ...
          : (a['User-Agent'] = 'axios/' + _i.version),
        u && !Ue.isStream(u))
      ) {
        if (!Buffer.isBuffer(u))
          if (Ue.isArrayBuffer(u)) u = Buffer.from(new Uint8Array(u));
          else if (Ue.isString(u)) u = Buffer.from(u, 'utf-8');
          else
            return i(
              Ye(
      ...
      var x = In.test(h),
        T = x ? t.httpsAgent : t.httpAgent,
        R = {
          path: li(d.path, t.params, t.paramsSerializer).replace(/^\?/, ''),
      ...
      var b = t.proxy;
      if (!b && b !== !1) {
        var v = h.slice(0, -1) + '_proxy',
          U = process.env[v] || process.env[v.toUpperCase()];
        if (U) {
          var w = gn.parse(U),
          ...
          if (
            L &&
            ((b = { host: w.hostname, port: w.port, protocol: w.protocol }), w.auth)
          ) {
            var j = w.auth.split(':');
      ...
      b &&
        ...
        Tn(R, b, h + '//' + d.hostname + (d.port ? ':' + d.port : '') + R.path));
      var B,
        z = x && (b ? In.test(b.protocol) : !0);
      t.transport
        ? (B = t.transport)
        : t.maxRedirects === 0
        ? (B = z ? pi : fi)
        : (t.maxRedirects && (R.maxRedirects = t.maxRedirects), (B = z ? hi : di)),
        t.maxBodyLength > -1 && (R.maxBodyLength = t.maxBodyLength);
      var A = B.request(R, function (g) {
        if (!A.aborted) {
          var D = g,
            F = g.req || A;
          if (g.statusCode !== 204 && F.method !== 'HEAD' && t.decompress !== !1)
            switch (g.headers['content-encoding']) {
              case 'gzip':
              case 'compress':
              case 'deflate':
                (D = D.pipe(mi.createUnzip())), delete g.headers['content-encoding'];
                break;
            }
          var Z = {
            status: g.statusCode,
          ...
          if (t.responseType === 'stream') (Z.data = D), Rn(s, i, Z);
          else {
            var m = [],
              _ = 0;
      ...
      if (
        (A.on('error', function (g) {
          (A.aborted && g.code !== 'ERR_FR_TOO_MANY_REDIRECTS') || i(Pt(g, t, null, A));
        }),
        t.timeout)
      ) {
...
var Qe = I((wa, Un) => {
  ...
  function bn(e, t) {
    !G.isUndefined(e) && G.isUndefined(e['Content-Type']) && (e['Content-Type'] = t);
  }
  function Ei() {
    var e;
    return (
      ...
      function (t, r) {
        return (
          ...
          G.isBlob(t)
            ...
            ? (bn(r, 'application/x-www-form-urlencoded;charset=utf-8'), t.toString())
      ...
      function (t) {
        ...
        if (s || (n && G.isString(t) && t.length))
          try {
            ...
            if (s) throw i.name === 'SyntaxError' ? vi(i, this, 'E_JSON_PARSE') : i;
          }
        return t;
      },
    ],
  ...
  Je.headers = { common: { Accept: 'application/json, text/plain, */*' } };
  G.forEach(['delete', 'get', 'head'], function (t) {
    Je.headers[t] = {};
  });
  G.forEach(['post', 'put', 'patch'], function (t) {
    Je.headers[t] = G.merge(Ci);
  });
  Un.exports = Je;
});
var Nn = I((ba, Sn) => {
...
var Fn = I((Sa, Bn) => {
  ...
  Bn.exports = function (t) {
    qt(t),
      (t.headers = t.headers || {}),
      (t.data = Dt.call(t, t.data, t.headers, t.transformRequest)),
      (t.headers = Ln.merge(
        t.headers.common || {},
        t.headers[t.method] || {},
        t.headers,
    ...
    var r = t.adapter || Ii.adapter;
    return r(t).then(
      function (n) {
        return qt(t), (n.data = Dt.call(t, n.data, n.headers, t.transformResponse)), n;
      },
      function (n) {
        return (
          gi(n) ||
...
var Hn = I((Aa, kn) => {
  ...
  var Mn = {},
    Ti = Dn.version.split('.');
  function qn(e, t) {
    for (var r = t ? t.split('.') : Ti, o = e.split('.'), n = 0; n < 3; n++) {
      if (r[n] > o[n]) return !0;
      if (r[n] < o[n]) return !1;
    }
    return !1;
  ...
  kn.exports = { isOlderVersion: qn, assertOptions: xi, validators: Ht };
});
var Kn = I((La, $n) => {
  'use strict';
  var Vn = H(),
    ...
    Ee = Xn.validators;
  function Se(e) {
    (this.defaults = e), (this.interceptors = { request: new Gn(), response: new Gn() });
  }
  Se.prototype.request = function (t) {
    ...
    if (!n) {
      var u = [jn, void 0];
      for (
        Array.prototype.unshift.apply(u, o), u.concat(s), i = Promise.resolve(t);
        u.length;
  ...
  Vn.forEach(['delete', 'get', 'head', 'options'], function (t) {
    Se.prototype[t] = function (r, o) {
      return this.request(Ze(o || {}, { method: t, url: r, data: (o || {}).data }));
    };
  });
...
async function nt(e, t = Ie) {
  try {
    ...
    if (o == 429) {
      if (!rt) {
        let s = 1e4 + (Ie + 1 - t) * 6e4 * Math.random();
        io.note({ title: `Received Code ${o}. ${n} Retrying in ${s}ms.` }), (rt = dt(s));
      }
      await rt, (rt = null);
    } else {
      let s = 1e3 + (Ie + 1 - t) * 4e3 * Math.random();
      X && io.note({ title: `Received Code ${o}. Retrying in ${s}ms.` }), await dt(s);
    }
    return nt(e, t - 1);
  }
}
...
function zt() {
  for (let e of Object.values(Ai))
    if (e.detectorFn(process.env)) {
      ...
      return (
        X && console.log(JSON.stringify(t, null, 2)), { ...t, inferredFromTaskRunner: !0 }
      );
    }
...
function Di(e) {
  ...
  let t = (n) => {
    ...
    o = (n) =>
      n.GITHUB_HEAD_REF ? n.GITHUB_HEAD_REF : n.GITHUB_REF ? n.GITHUB_REF : null;
  return {
    branch: t(e),
    ref: o(e),
    title: Yt(),
...
function Gi(e) {
  return (
    ...
    {
      branch:
        e.SYSTEM_PULLREQUEST_PULLREQUESTNUMBER ?? e.BUILD_SOURCEBRANCHNAME ?? 'unknown',
      ref: null,
      ...
      authorAvatarUrl: null,
      repositoryUrl:
        e.SYSTEM_PULLREQUEST_SOURCEREPOSITORYURI ?? e.BUILD_REPOSITORY_URI ?? null,
    }
  );
}
function ji(e) {
...
function Yt() {
  try {
    return (0, Wt.execSync)('git log -1 --pretty=%B', { encoding: 'utf-8' }).trim();
  } catch {
    return null;
  }
}
function uo() {
  try {
    return (0, Wt.execSync)('git log -1 --pretty=%aN', { encoding: 'utf-8' }).trim();
  } catch {
    return null;
  }
}
var Wt,
  ...
  co = te(() => {
    ...
    Ai = {
      ...
      TRAVIS_CI: { detectorFn: Fi, contextRetrieverFn: Pi },
      GITHUB_ACTIONS: { detectorFn: Mi, contextRetrieverFn: Di },
...
var Jt,
  ...
  fo = te(() => {
    'use strict';
    Jt = require('perf_hooks');
    Kt();
    he();
    lo();
    (Xi = []),
      (Qt = (e) => {
        let t = Jt.performance.now();
        return {
          recordMetric: (o) => {
            let n = Jt.performance.now();
  ...
  ho = te(() => {
    ...
    ({ output: er } = de()),
      (tr = class {
        ...
        async createRunGroup(t, r, o, n, s, i, u, a, l, c, f) {
          var d;
          let p = Qt('createRunGroup');
          try {
            let h = await nt(() =>
            ...
            p.recordMetric(
              (d = h == null ? void 0 : h.axiosException) != null && d.response
                ? Ne(h.axiosException.response)
                : Zt,
            ),
              er.error({ title: h.message }),
              process.exit(1);
          }
        }
...
var vr = require('os'),
  Cr = require('path');
function Er(e) {
  return (0, Cr.join)((0, vr.tmpdir)(), `run-group-${e}-marker.lock`);
}
async function $i() {
  var c;
  let e = JSON.parse(process.env.NX_CLOUD_LIGHT_CLIENT_RESOLUTION_PATHS),
    { configureLightClientRequire: t } = (Pe(), Fe(cr));
  t(e);
  let { getCloudOptions: r } = (xr(), Fe(Tr)),
    { RunGroupApi: o } = (ho(), Fe(po)),
    { getRunGroup: n, VERBOSE_LOGGING: s } = (he(), Fe(_r)),
    { nxCloudOptions: i } = r(),
    u = new o(i),
    a = ft();
  ...
  let l = n();
  Ki(l, s),
    await u.sendHeartbeat(a, l),
    setInterval(() => u.sendHeartbeat(a, l), 5e3),
    (c = process.stdout) == null || c.write('heartbeat-ready');
}
function Ki(e, t) {
  let r = async () => {
