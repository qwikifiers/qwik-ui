    ...
    <Drawer id={drawerName} {...args}>
      <DrawerContent>
        <div q:slot="drawer-content">
          <h3 className="font-bold text-lg">regular layout</h3>
          <p className="py-4">The content of the regular layout</p>
        </div>
      ...
      <DrawerSide id={drawerName}>
        <div className="menu p-4 overflow-y-auto w-80 bg-base-100 text-base-content">
          <h3 className="font-bold text-lg">drawer side content</h3>
          <p className="py-4">The content of the drawer side</p>
        </div>
      </DrawerSide>
    </Drawer>;
