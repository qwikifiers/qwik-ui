...
export const panelVariants = cva(
  [
    'fixed w-full bg-background p-6 text-foreground transition-all backdrop:brightness-50 backdrop:backdrop-blur-xs',
    'data-closing:duration-300 data-open:duration-300 data-open:animate-in data-closing:animate-out',
    'data-closing:backdrop:duration-300 data-open:backdrop:duration-300 data-open:backdrop:animate-in data-closing:backdrop:animate-out data-closing:backdrop:fade-out data-open:backdrop:fade-in',
  ],
  {
    variants: {
      position: {
        center:
          'max-w-lg rounded-base shadow-lg data-closed:fade-out data-open:fade-in data-closed:zoom-out-95 data-open:zoom-in-95 data-open:slide-in-from-bottom-2 data-closing:backdrop:fade-out data-open:backdrop:fade-in',
