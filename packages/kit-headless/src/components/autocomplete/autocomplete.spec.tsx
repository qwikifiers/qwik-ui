...
// type RegularAutocompleteProps = {
//   defaultValue?: string;
//   autoFocus?: boolean;
// };

// const RegularAutocomplete = component$(
//   ({ defaultValue, autoFocus }: RegularAutocompleteProps) => {
...
//           <AutocompleteControl>
//             <AutocompleteInput autoFocus={autoFocus} placeholder="random placeholder" />
...
//   it.only(`GIVEN an Autocomplete component
//       WHEN there is a default value and it doesn't exactly match an option
//       THEN it should open the listbox
//   `, () => {
//     cy.mount(<RegularAutocomplete autoFocus={true} defaultValue="appl" />);
