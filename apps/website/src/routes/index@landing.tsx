  ...
  return (
    <div class="flex flex-col gap-8 text-gray-950 dark:text-white">
      <h1 class="text-3xl lg:text-5xl text-center leading-normal font-bold">
        <span class="text-qwikui-purple-400">Qwik</span>{' '}
        <span class="text-qwikui-blue-500">UI</span>
      </h1>
      ...
      <div class="gap-8 flex flex-wrap justify-center justify-items-center">
        ...
        >
          <Card>
            ...
            />
            <CardBody
              class={`px-8 py-6 border-t-[2px] border-slate-800 dark:border-slate-300 border-white`}
            >
          ...
          >
            <Card>
              <CardImage
                ...
                height="408"
                alt={`fluffy kit`}
                class="h-64 w-full object-cover rounded-t-[.225rem]"
              />
              <CardBody
                class={`px-8 py-6 border-t-[2px] border-slate-800 dark:border-slate-300 border-white`}
              >
