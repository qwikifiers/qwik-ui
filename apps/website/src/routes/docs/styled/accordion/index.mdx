...
export const AccordionRoot = component$<PropsOf<typeof Accordion.Root>>((props) => (
  <Accordion.Root animated {...props} class={props.class}>
    <Slot />
  </Accordion.Root>
));
...
export const AccordionTrigger = component$<
  PropsOf<typeof AccordionTrigger> & {
    header?: PropsOf<typeof AccordionHeader>['as'];
  }
>(({ header = 'h3', ...props }) => {
  return (
...
export const AccordionContent = component$<PropsOf<typeof AccordionContent>>((props) => {
  return (
    <Accordion.Content
      {...props}
      class={cn(
