...
<Example name="accordion/non-collapsible" />
...
<Example name="accordion/default-value" />
...
<Example name="accordion/custom-heading" />
...
<Example name="accordion/selected-index" />
...
<Example name="accordion/focused-index" />
...
<Example name="accordion/dynamic" />
