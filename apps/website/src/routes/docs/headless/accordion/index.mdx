  ...
  <AccordionRoot class="accordion-wrapper" animated>
    <AccordionItem>
      ...
      <AccordionContent class="accordion-content">
        <p>
          Yes, if you wrap the AccordionHeader component around the trigger, screen
          readers will announce it properly.
        </p>
      </AccordionContent>
    </AccordionItem>
    <AccordionItem>
    ...
    <AccordionItem>
      ...
      <AccordionContent class="accordion-content">
        <p>
          You can do that by setting the <strong>behavior</strong> prop to "multi" on the
          Accordion
        </p>
      </AccordionContent>
    </AccordionItem>
...
<MultiAccordion>
  ...
  <AccordionRoot behavior="mutli" class="accordion-wrapper" animated>
    <AccordionItem>
      ...
      <AccordionContent class="accordion-content">
        <p>
          100%. The trigger has a [data-state] selector that can be styled when equal to
          the open or closed values. For example, [data-state="open"]
        </p>
      </AccordionContent>
    </AccordionItem>
    <AccordionItem>
      ...
      <AccordionContent class="accordion-content">
        <p>
          It's typed using QwikIntrinsicElements, meaning you can treat it like an
          element!
        </p>
      </AccordionContent>
    </AccordionItem>
...
<NonCollapsibleAccordion>
  ...
  <AccordionRoot class="accordion-wrapper" animated={true} collapsible={false}>
    ...
    <AccordionItem>
      ...
      <AccordionContent class="accordion-content">
        <p>
          Of course! You can also use the onFocusIndexChange$ and onSelectedIndexChange$
          custom events.
        </p>
      </AccordionContent>
    </AccordionItem>
...
<DefaultValueAccordion>
  ...
  <AccordionRoot class="accordion-wrapper">
    ...
    <AccordionItem defaultValue={true}>
      ...
      <AccordionContent class="accordion-content">
        <p>
          You can open me by default by putting the defaultValue prop on the Accordion
          Item.
        </p>
      </AccordionContent>
    </AccordionItem>
