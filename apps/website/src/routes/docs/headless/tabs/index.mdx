...
<CodeSnippet name="snippets/long" />

### The short version

<CodeSnippet name="snippets/short" />
...
<Example name="selected-tab-id" />

## Add a "selected" prop

You can add a "selected" prop to the Tab component to make it selected by default.

<Example name="selected-prop" />

## Tabs onClick$

You can pass a custom `onClick$` handler to the Tabs component.

<Example name="on-click-tabs" />
