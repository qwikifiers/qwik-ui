...
<div class="text-white bg-gradient-to-b from-orange-700 to-orange-800 dark:from-red-700 dark:to-red-800 p-4 lg:p-6 rounded-xl shadow-light-medium dark:shadow-dark-medium">
