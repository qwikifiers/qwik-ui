...
<CodeSnippet name="snippets/qwik-ui-provider" />
...
<CodeSnippet name="snippets/context-ids" />
...
<CodeSnippet name="snippets/resolved-option" />
## Adding a filter
...
<CodeSnippet name="snippets/custom-keys" />
...
<div class="shadow-light-medium dark:shadow-dark-medium rounded-xl bg-gradient-to-b from-orange-700 to-orange-800 p-4 text-white dark:from-red-700 dark:to-red-800 lg:p-6">
