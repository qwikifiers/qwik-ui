...
<p class="text-slate-600 dark:text-slate-500 font-semibold text-lg mt-[-8px]">An open source toolkit for creating accessible, customizable, and rich user interfaces with Qwik.</p>
...
Our aim is to ensure Qwik UI is not just an effective, but also a simple and reliable choice for developing applications. 
...
>
    ...
    <AccordionItem>
        ...
        <AccordionContent class="animation-1 overflow-hidden text-slate-700 dark:text-slate-200 border-t-[1px] border-slate-200 dark:border-slate-800">
            <div class="py-4">
                If you're using Qwik-React, Qwik-Angular, or an Astro integration, we suggest incrementally adding Qwik UI components to your application.
