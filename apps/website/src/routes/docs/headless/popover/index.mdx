...
import { Popover, Popover.Trigger } from '@qwik-ui/headless';

export default component$(() => {
  return (
    <>
      <Popover.Trigger popovertarget="building-blocks">Inside Trigger</Popover.Trigger>
...
## Versatile use cases <span class="ml-2 text-red-400 dark:text-red-400 text-base px-2 bg-red-100 rounded-base shadow-md border-b-2 border-[1px] border-red-200 dark:border-red-300">WIP</span>
...
<Popover.Trigger popovertarget="get-20-off">Get 20% off your next order!</Popover.Trigger>
