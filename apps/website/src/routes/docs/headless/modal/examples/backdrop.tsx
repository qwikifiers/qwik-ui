...
import styles from '../snippets/backdrop.css?inline';
...
export default component$(() => {
  ...
  return (
    <>
      ...
      <Modal
        bind:show={showSig}
        class="shadow-dark-medium my-backdrop max-w-[25rem] rounded-md bg-slate-950 p-[28px] text-slate-50 text-slate-50"
      >
        <ModalHeader>
