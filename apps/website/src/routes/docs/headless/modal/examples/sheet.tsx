...
export default component$(() => {
  ...
  return (
    <>
      ...
      <Modal
        bind:show={showSig}
        class="sheet bg-background text-foreground rounded-base fixed bottom-[50%] right-0 top-[50%] mr-0 h-[80vh] max-w-[25rem] border-0 p-[28px] shadow-md backdrop:backdrop-blur backdrop:backdrop-brightness-50 dark:backdrop:backdrop-brightness-100"
      >
        <ModalHeader>
