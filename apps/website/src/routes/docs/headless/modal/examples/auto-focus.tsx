...
export default component$(() => {
  ...
  return (
    <>
      ...
      <Modal
        bind:show={showSig}
        class="bg-background text-foreground rounded-base max-w-[25rem] p-[28px] shadow-md backdrop:backdrop-blur backdrop:backdrop-brightness-50 dark:backdrop:backdrop-brightness-100"
      >
        <ModalHeader>
