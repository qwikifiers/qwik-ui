...
export default component$(() => {
  ...
  return (
    <>
      ...
      <Modal
        bind:show={showSig}
        class="bottom-sheet bg-background text-foreground fixed bottom-0 mb-0 max-w-[25rem] rounded-sm border-0 p-[28px] shadow-md backdrop:backdrop-blur backdrop:backdrop-brightness-50 dark:backdrop:backdrop-brightness-100"
      >
        <ModalHeader>
