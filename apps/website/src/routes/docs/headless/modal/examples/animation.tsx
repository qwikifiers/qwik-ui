...
export default component$(() => {
  ...
  return (
    <>
      ...
      <Modal
        bind:show={showSig}
        class="my-animation shadow-dark-medium max-w-[25rem] rounded-md bg-slate-950 p-[28px] text-slate-50 text-slate-50 backdrop:backdrop-blur backdrop:backdrop-brightness-50 dark:backdrop:backdrop-brightness-100"
      >
        <ModalHeader>
