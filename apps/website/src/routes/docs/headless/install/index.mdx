...
<InstallSnippet packages={packages} />
    ...
    <div class="flex flex-col gap-4 md:flex-row mx-6 lg:mx-8">
        <a class="flex-1 border-none" href="#qwik-city">
            <span class="p-8 rounded-sm gap-4 flex flex-col items-center border transition duration-300 ease-step hover:bg-accent">
...
<InstallSnippet packages={qwikCityPackages} />
    ...
    <div class="">
        <img src={qwikCityCLI} class="block max-w-full rounded-sm mb-6 border" />
    </div>
    ...
    <div class="whitespace-pre-wrap bg-secondary/20  px-5 py-4 lg:px-7 border border-secondary rounded-sm mb-6 lg:mb-12">
    ...
    <div class="">
        <img src={astroCLI} class="block max-w-full rounded-sm mb-6 border" />
    </div>
    ...
    <div class="">
        <img src={qwikdevAstroCLI} class="block max-w-full rounded-sm mb-6 border" />
    </div>
