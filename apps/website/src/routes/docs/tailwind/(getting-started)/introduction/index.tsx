  ...
  return (
    <>
      ...
      <p class="mt-8 leading-relaxed mb-10">
        Welcome to the Tailwind Kit, a collection of ready-to-use, beautifully styled
        ...
        designed to work seamlessly with Qwik. The Tailwind Kit is perfect for developers
      ...
      <p class="text-lg mb-6">
        The Tailwind Kit offers a powerful solution for developers looking to create
        visually appealing, consistent designs without the need to write custom CSS. By
        utilizing the popular Tailwind CSS framework, the Tailwind Kit provides a set of
