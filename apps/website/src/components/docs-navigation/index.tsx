...
export const DocsNavigation = component$(({ linksGroups }: NavigationDocsProps) => {
  ...
  return (
    <nav
      class={`fixed inset-0 top-20 z-10 flex-col gap-4 overflow-y-auto border-r-[1px] border-slate-200 bg-white pb-6 [grid-area:nav] dark:border-slate-800 dark:bg-slate-900  lg:w-80
