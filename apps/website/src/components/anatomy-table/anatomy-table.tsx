        ...
        <table class="mb-6 w-full min-w-[540px] text-left sm:min-w-full">
          <tbody class="divide-y">
            <tr class="text-foreground">
              <td class="w-2/6 p-2 font-semibold whitespace-nowrap sm:pl-0">
                {firstColumnLabel}
              </td>
              <td class="w-4/6 p-2 font-semibold whitespace-nowrap sm:pl-0">
                Description
              </td>
            </tr>
            {propDescriptors?.map((propDescriptor) => {
              return (
                <tr key={propDescriptor.name}>
                  <td class="align-center py-3 pr-2 pl-2 sm:pl-0 md:align-baseline">
