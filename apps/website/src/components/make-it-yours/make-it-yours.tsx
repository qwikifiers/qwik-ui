...
export default component$<PropsOf<typeof Button> & { withText?: boolean }>(
  ({ withText = true, ...props }) => {
    useStyles$(`
    ...
    return (
      <div>
        ...
        >
          <LuSlidersHorizontal class={cn(withText && 'h-4 w-4 lg:mr-3')} />
          <span class={cn('hidden', withText && 'lg:block')}>Make it yours</span>
        </Button>
        <Modal
