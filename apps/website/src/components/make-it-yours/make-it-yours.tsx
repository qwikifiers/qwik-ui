                ...
                >
                  <span
                    class={cn(
                      ...
                      colorTheme === 'slate-100' && 'bg-slate-100',
                      colorTheme === 'gray-100' && 'bg-gray-100',
                      colorTheme === 'zinc-100' && 'bg-zinc-100',
                      colorTheme === 'neutral-100' && 'bg-neutral-100',
                      colorTheme === 'stone-100' && 'bg-stone-100',
                      ...
                      colorTheme === 'slate-200' && 'bg-slate-200',
                      colorTheme === 'gray-200' && 'bg-gray-200',
                      colorTheme === 'zinc-200' && 'bg-zinc-200',
                      colorTheme === 'neutral-200' && 'bg-neutral-200',
                      colorTheme === 'stone-200' && 'bg-stone-200',
