        ...
        <ModalContent class="mb-2 py-4">
          ...
          <div class="grid grid-cols-[repeat(22,1fr)]">
            {colorThemeOptions.map((colorTheme) => {
              ...
              if (
                colorTheme.includes('slate-100') ||
                colorTheme.includes('gray-100') ||
                colorTheme.includes('zinc-100') ||
                colorTheme.includes('neutral-100') ||
                colorTheme.includes('stone-100') ||
                colorTheme.includes('slate-200') ||
                colorTheme.includes('gray-200') ||
                colorTheme.includes('zinc-200') ||
                colorTheme.includes('neutral-200') ||
                colorTheme.includes('stone-200')
              )
                return <span></span>;
              return (
                <Button
                ...
                >
                  {(colorTheme?.includes('slate-800') ||
                    colorTheme?.includes('gray-800') ||
                    colorTheme?.includes('zinc-800') ||
                    colorTheme?.includes('neutral-800') ||
                    colorTheme?.includes('stone-800') ||
                    colorTheme?.includes('slate-900') ||
                    colorTheme?.includes('gray-900') ||
                    colorTheme?.includes('zinc-900') ||
                    colorTheme?.includes('neutral-900') ||
                    colorTheme?.includes('stone-900')) &&
                  theme?.includes('dark') ? (
                    <span
                      class={cn(
                        'flex h-3 w-3 shrink-0 rounded-none',
                        colorTheme === 'slate-900' && 'bg-slate-100',
                        colorTheme === 'gray-900' && 'bg-gray-100',
                        colorTheme === 'zinc-900' && 'bg-zinc-100',
                        colorTheme === 'neutral-900' && 'bg-neutral-100',
                        colorTheme === 'stone-900' && 'bg-stone-100',
                        colorTheme === 'slate-800' && 'bg-slate-200',
                        colorTheme === 'gray-800' && 'bg-gray-200',
                        colorTheme === 'zinc-800' && 'bg-zinc-200',
                        colorTheme === 'neutral-800' && 'bg-neutral-200',
                        colorTheme === 'stone-800' && 'bg-stone-200',
                      )}
                    />
                  ) : (
                    <span
                      class={cn(
                        ...
                        colorTheme === 'slate-300' && 'bg-slate-300',
                        colorTheme === 'gray-300' && 'bg-gray-300',
                        colorTheme === 'zinc-300' && 'bg-zinc-300',
                        colorTheme === 'neutral-300' && 'bg-neutral-300',
                        colorTheme === 'stone-300' && 'bg-stone-300',
                        ...
                        colorTheme === 'slate-400' && 'bg-slate-400',
                        colorTheme === 'gray-400' && 'bg-gray-400',
                        colorTheme === 'zinc-400' && 'bg-zinc-400',
                        colorTheme === 'neutral-400' && 'bg-neutral-400',
                        colorTheme === 'stone-400' && 'bg-stone-400',
                        ...
                        colorTheme === 'slate-500' && 'bg-slate-500',
                        colorTheme === 'gray-500' && 'bg-gray-500',
                        colorTheme === 'zinc-500' && 'bg-zinc-500',
                        colorTheme === 'neutral-500' && 'bg-neutral-500',
                        colorTheme === 'stone-500' && 'bg-stone-500',
                        ...
                        colorTheme === 'slate-600' && 'bg-slate-600',
                        colorTheme === 'gray-600' && 'bg-gray-600',
                        colorTheme === 'zinc-600' && 'bg-zinc-600',
                        colorTheme === 'neutral-600' && 'bg-neutral-600',
                        colorTheme === 'stone-600' && 'bg-stone-600',
                        ...
                        colorTheme === 'slate-700' && 'bg-slate-700',
                        colorTheme === 'gray-700' && 'bg-gray-700',
                        colorTheme === 'zinc-700' && 'bg-zinc-700',
                        colorTheme === 'neutral-700' && 'bg-neutral-700',
                        colorTheme === 'stone-700' && 'bg-stone-700',
                        ...
                        colorTheme === 'slate-800' && 'bg-slate-800',
                        colorTheme === 'gray-800' && 'bg-gray-800',
                        colorTheme === 'zinc-800' && 'bg-zinc-800',
                        colorTheme === 'neutral-800' && 'bg-neutral-800',
                        colorTheme === 'stone-800' && 'bg-stone-800',
                        ...
                        colorTheme === 'slate-900' && 'bg-slate-900',
                        colorTheme === 'gray-900' && 'bg-gray-900',
                        colorTheme === 'zinc-900' && 'bg-zinc-900',
                        colorTheme === 'neutral-900' && 'bg-neutral-900',
                        colorTheme === 'stone-900' && 'bg-stone-900',
