            ...
            <ModalContent class="mb-2 py-4">
              ...
              <div class="grid grid-cols-[repeat(22,1fr)]">
                {primaryOptions.map((primary) => {
                  ...
                  if (
                    (primary === 'primary-slate-100' ||
                      primary === 'primary-slate-200' ||
                      primary === 'primary-slate-300' ||
                      primary === 'primary-slate-400' ||
                      primary === 'primary-slate-500' ||
                      primary === 'primary-slate-600' ||
                      primary === 'primary-slate-700' ||
                      primary === 'primary-gray-100' ||
                      primary === 'primary-gray-200' ||
                      primary === 'primary-gray-300' ||
                      primary === 'primary-gray-400' ||
                      primary === 'primary-gray-500' ||
                      primary === 'primary-gray-600' ||
                      primary === 'primary-gray-700' ||
                      primary === 'primary-zinc-100' ||
                      primary === 'primary-zinc-200' ||
                      primary === 'primary-zinc-300' ||
                      primary === 'primary-zinc-400' ||
                      primary === 'primary-zinc-500' ||
                      primary === 'primary-zinc-600' ||
                      primary === 'primary-zinc-700' ||
                      primary === 'primary-neutral-100' ||
                      primary === 'primary-neutral-200' ||
                      primary === 'primary-neutral-300' ||
                      primary === 'primary-neutral-400' ||
                      primary === 'primary-neutral-500' ||
                      primary === 'primary-neutral-600' ||
                      primary === 'primary-neutral-700' ||
                      primary === 'primary-stone-100' ||
                      primary === 'primary-stone-200' ||
                      primary === 'primary-stone-300' ||
                      primary === 'primary-stone-400' ||
                      primary === 'primary-stone-500' ||
                      primary === 'primary-stone-600' ||
                      primary === 'primary-stone-700') &&
                    theme?.includes('dark')
                  ) {
                    return (
                      <Button
